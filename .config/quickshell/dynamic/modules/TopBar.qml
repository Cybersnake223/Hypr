        ...
        PanelWindow {
            ...
            Rectangle {
                ...
                gradient: Gradient {
                    ...
                    GradientStop {
                        position: 0.5
                        color: Qt.rgba(mocha.text.r, mocha.text.g, mocha.text.b, 0.22)
                    }
                    GradientStop {
                        position: 0.7
                        color: "transparent"
            ...
            // Prevents repeaters (Tray) from flickering on data updates
            ...
            Item {
                ...
                Behavior on width {
                    NumberAnimation {
                        ...
                        easing.bezierCurve: SharedConfig.animEaseOut
                    }
                }
            }
                    ...
                    Row {
                        ...
                        Repeater {
                            ...
                            delegate: Rectangle {
                                ...
                                color: stateLabel === "active" ? "transparent" : (isHovered ? barWindow.overlay0_09 : (stateLabel === "occupied" ? barWindow.surface2_09 : "transparent"))
                                ...
                                Rectangle {
                                    ...
                                    gradient: Gradient {
                                        ...
                                        GradientStop {
                                            position: 1.0
                                            color: Qt.lighter(barWindow.wsActiveColor, 1.3)
                                            Behavior on color {
                                                enabled: barWindow.visible
                                                ColorAnimation {
                                                    duration: 300
                                    ...
                                    Rectangle {
                                        ...
                                        gradient: Gradient {
                                            ...
                                            GradientStop {
                                                position: 0.5
                                                color: Qt.rgba(barWindow.mocha.text.r, barWindow.mocha.text.g, barWindow.mocha.text.b, 0.30)
                                            }
                                            GradientStop {
                                                position: 1.0
                                                color: "transparent"
                                ...
                                Text {
                                    ...
                                    color: wsName === "special" ? (stateLabel === "active" ? "#000000" : mocha.green) : (stateLabel === "active" ? "#000000" : (isHovered ? mocha.crust : (stateLabel === "occupied" ? mocha.text : mocha.overlay0)))
            ...
            RowLayout {
                ...
                Rectangle {
                    ...
                    Row {
                        ...
                        Rectangle {
                            width: 1
                            height: sysLayout.pillHeight * 0.55
                            radius: 1
                            color: SharedConfig.hairline
                        }
                        ...
                        Rectangle {
                            ...
                            Row {
                                ...
                                Text {
                                    anchors.verticalCenter: parent.verticalCenter
                                    text: SharedConfig.micIcon
                                    font.family: SharedConfig.nerdFont
                                    font.pixelSize: barWindow.s(16)
                                    color: SharedConfig.micMuted ? mocha.red : mocha.text
                                }
                                Text {
                                    anchors.verticalCenter: parent.verticalCenter
                                    text: SharedConfig.micPercent + "%"
                                    font.family: SharedConfig.monoFont
                                    font.pixelSize: barWindow.s(13)
                                    font.weight: Font.Black
                                    color: SharedConfig.micMuted ? mocha.red : mocha.text
                            ...
                            MouseArea {
                                ...
                                anchors.fill: parent
                                hoverEnabled: true
                                onClicked: Quickshell.execDetached(["bash", "-c", "~/.config/quickshell/dynamic/scripts/osd_volume.sh mic"])
                            }
                        }
                        ...
                        Rectangle {
                            ...
                            Row {
                                ...
                                Text {
                                    anchors.verticalCenter: parent.verticalCenter
                                    text: SharedConfig.volIcon
                                    font.family: SharedConfig.nerdFont
                                    font.pixelSize: barWindow.s(16)
                                    color: SharedConfig.volMuted ? mocha.red : mocha.text
                                }
                                Text {
                                    anchors.verticalCenter: parent.verticalCenter
                                    text: SharedConfig.volPercent + "%"
                                    font.family: SharedConfig.monoFont
                                    font.pixelSize: barWindow.s(13)
                                    font.weight: Font.Black
                                    color: SharedConfig.volMuted ? mocha.red : mocha.text
                            ...
                            MouseArea {
                                ...
                                anchors.fill: parent
                                hoverEnabled: true
                                onClicked: Quickshell.execDetached(["bash", "-c", "~/.config/quickshell/dynamic/scripts/osd_volume.sh mute"])
                            }
                        }
                        ...
                        Rectangle {
                            ...
                            Row {
                                ...
                                Text {
                                    ...
                                    font.family: SharedConfig.nerdFont
                                    font.pixelSize: SharedConfig.isDesktop ? barWindow.s(14) : barWindow.s(13)
